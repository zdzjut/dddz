package com.dddz.ffmpeg.callback.worker;
...
import com.dddz.ffmpeg.callback.EventCallBack;
import com.dddz.ffmpeg.callback.EventCallBackType;
import com.dddz.ffmpeg.data.CommandTasker;
import com.dddz.ffmpeg.data.TaskerEventMsg;
...
public class EventMsgNetWorker extends Thread implements EventCallBack{
	private final static Logger logger = LoggerFactory.getLogger(EventMsgNetWorker.class);
	...
	public EventMsgNetWorker(int timeout,String url) {
		super();
